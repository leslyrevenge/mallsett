  ...
  render() {
    ...
    return (
      <Row gutter={24}>
        ...
        <Row gutter={24}>
        <Col span="12">
        { /* start   lifespan range */ }
         <Popover content={ 
              <div>
                {<IntlMessages id="form.part.lifespan.name.popover.content" />} 
              </div>
            } title={<IntlMessages id="form.part.lifespan.min.popover.title" />}  trigger="click">
            <Icon type="question-circle-o" />  <IntlMessages id="form.part.lifespan.min" />  </Popover>
        ...
        { /* start   lifespan range */ }
         <Popover content={ 
              <div>
               {<IntlMessages id="form.part.lifespan.max.popover.content" />} 
              </div>
            } title={<IntlMessages id="form.part.lifespan.max.popover.title" />}  trigger="click">
            <Icon type="question-circle-o" />  <IntlMessages id="form.part.lifespan.max" />  </Popover>
            <DatePicker size=""  style={{ width: '100%', marginBottom: 15, marginTop: 5, borderRadius: 0 }} />
          </Col>
      </Row>
      <Row gutter={8}>
